$(document).ready(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            $.alert({
                                ...
                                content:
                                    response.message ||
                                    "Our Practice added successfully!",
                            });
                            form.reset();
                            descriptionEditor.setContents([]);
                            $("small.text-danger").hide();
                            setTimeout(() => {
                                window.location.href = ourpracticeDetailshome;
                            }, 1000);
                        },
                        error: function (xhr) {
                            $("#submitTherapy")
    ...
    if (page === "show-ourpractice") handleShow();
});
