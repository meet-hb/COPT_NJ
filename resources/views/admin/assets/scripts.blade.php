    ...
    <script src="{{ url('/') }}/assets/admin/dist/js/jquery-confirm.min.js"></script>
    <!-- Bootstrap 4 -->
    ...
    <script src="{{ url('/') }}/assets/admin/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js">
    </script>
    <!-- BS-Stepper -->
