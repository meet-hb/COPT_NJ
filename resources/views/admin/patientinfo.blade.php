...
<body class="hold-transition sidebar-mini layout-fixed" data-page="show-patientinfo">
    <div class="wrapper">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form id="patientinfoForm" enctype="multipart/form-data">
                                        <input type="hidden" name="id" id="id"
                                            value="{{ $data->id ?? '' }}">
                                        <div class="form-group mb-3">
                                            <label for="description" class="form-label">Patient Info</label>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.21.0/additional-methods.min.js"
        ...
        crossorigin="anonymous" refer="no-referrer"></script>
    <script src="{{ url('/') }}/assets/admin/ajax/patientinfo.js"></script>

    <script>
        var patientinfoDetailOp = '{{ route('admin.patientinfoDetailOp') }}';
        var patientinfoDetailshome = '{{ route('admin.patientinfo') }}';
    </script>
</body>
